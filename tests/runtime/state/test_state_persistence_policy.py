...
def test_memory_backend_policy_marks_runtime_state_ephemeral() -> None:
    ...
    assert policy.relationship_store == "ephemeral"
    assert policy.affect_store == "ephemeral"
...
def test_sqlite_backend_policy_marks_durable_companion_state() -> None:
    ...
    assert policy.relationship_store == "durable"
    assert policy.affect_store == "durable"

...
- [ ] No new service locator, global registry, or temporary wrapper was added.
- [ ] No compatibility shim was added unless the task explicitly requested a migration path with removal criteria and tests.

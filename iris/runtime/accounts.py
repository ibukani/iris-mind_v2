...
class AccountLinkingService:
    """Internal runtime service for explicit account-to-actor linking."""

    def __init__(self, account_store: AccountStore) -> None:
        """Initialize the service with an account store."""
        self._account_store = account_store

    async def get_account_by_id(self, account_id: AccountId) -> AccountProfile | None:
    ...
    async def unlink_account(self, account_id: AccountId) -> AccountProfile:

...
class ObservationContext(_message.Message):
    ...
    ACTOR_REF_FIELD_NUMBER: _builtins.int
    ...
    @_builtins.property
    def actor_ref(self) -> _identity_pb2.ExternalActorRef: ...
    @_builtins.property
    ...
    def __init__(
        ...
        *,
        ...
        space_id: _builtins.str = ...,
        source: _builtins.str = ...,
        actor_ref: _identity_pb2.ExternalActorRef | None = ...,
        metadata: _abc.Mapping[_builtins.str, _builtins.str] | None = ...,
    ) -> None: ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["actor", b"actor", "actor_ref", b"actor_ref"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["account_id", b"account_id", "actor", b"actor", "actor_ref", b"actor_ref", "device_id", b"device_id", "metadata", b"metadata", "source", b"source", "space_id", b"space_id"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...

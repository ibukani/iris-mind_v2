...
Config exposure は Runtime Config v2 の方針に従う。Control Plane schema / manifest は typed runtime config と generated schema provider contract を source of truth にする。
